...
namespace Records
{
	...
	double HourlyEmployee::get_hourly_rate()
	{
		return hourly_rate;
	}
	...
	double HourlyEmployee::get_overtime_hours()
	{
	...
	double HourlyEmployee::get_regular_hours()
	{
	...
	double HourlyEmployee::get_regular_pay()
	{
		return regular_pay;
	}
	...
	double HourlyEmployee::get_overtime_pay()
	{
		return overtime_pay;
	}
	...
	double HourlyEmployee::get_gross_pay()
	{
		return gross_pay;
	}
	...
	double HourlyEmployee::get_tax_rate()
	{
		return tax_rate;
	}
	void HourlyEmployee::compute_net_pay()
	{
		...
		net_pay = gross_pay - tax_amount; // also not correct due to tax_rate being wrong
	}

	double HourlyEmployee::get_net_pay()
	{
		return net_pay;
	}
}