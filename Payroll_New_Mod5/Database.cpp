...
namespace Records
{
	...
	shared_ptr<Employee> Database::add_hourly_employee(string in_first_name, string in_last_name,
 ...
 void Database::add_salaried_employee(string in_first_name, string in_last_name,
	...
	shared_ptr<Employee> Database::get_employee(string in_first_name, string in_last_name)
	{
		for (auto iter = mEmployees.begin(); iter != mEmployees.end(); ++iter)
		{
